...
void CPattternGeneratorView::OnDraw(CDC* pDC)
{
	...
	pDC->Ellipse(500, 400, 100, 0); //planet3
	
	pDC->Ellipse(450, 350, 150, 50); // planet2

	pDC->Ellipse(400, 300, 200, 100); // planet1 
	...
	{
		CBrush brushBlack4(RGB(0, 0, 255));
		CBrush* pO5dBrush = pDC->SelectObject(&brushBlack4);// planet4
		pDC->Ellipse(x1 + 10, y1 + 10, x1 - 10, y1 - 10);
		pDC->SelectObject(pO5dBrush); 
	}

	CBrush brushBlack3(RGB(11, 252, 17));
	CBrush* pO4dBrush = pDC->SelectObject(&brushBlack3);// planet3
